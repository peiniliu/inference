...
num_memory=128
num_host=4
hosts="nxt2026 nxt2027 nxt2028 nxt2029 nxt2030"
...
function change_affinity () {
  ...
  do
    ...
    then
      ...
      ssh -o StrictHostKeyChecking=no $host "sudo sh /gpfs/bsc_home/xpliu/cpuset.sh 1 2-17,20-35"
    elif [ $1 == "cpumemory" ]
    then
      echo "cpumemory"
      if [ $2 == 1 ]
      then
        ...
        ssh -o StrictHostKeyChecking=no $host "sudo sh /gpfs/bsc_home/xpliu/cpumem.sh 1"
      fi
    else
      echo "cpumem"
    fi
    ...
    do
        ...
        do
            ...
            do 
                ...
                change_affinity $K8S_ENV $container $hosts
                sleep 10
