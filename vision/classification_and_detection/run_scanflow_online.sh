...
#graph
#./main.sh --dataset imagenet_seldon --dataset-path test_imagenet --scenario Offline --model-name resnet50 --server 172.30.0.50:40000 --namespace scanflow-mlperf-dataengineer --deployment_name online-inference-graph --backend seldon --output output --count 2 
