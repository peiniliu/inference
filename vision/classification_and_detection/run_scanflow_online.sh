...
#graph
/gpfs/bsc_home/xpliu/inference/vision/classification_and_detection/main.sh --dataset imagenet_seldon --dataset-path data_imagenet --scenario Offline --model-name resnet50 --server 172.30.0.53:40000 --namespace scanflow-mlperf-dataengineer --max-batchsize 4 --deployment_name online-inference-graph --backend seldon --output output
